 ...
 * @author 刘祎鹏
 */
public class BeanCtxStellarData
{
//spectrumLevel
    private int OID = 0;
    private double x = 0;
    ...
    //光谱级别
    private int spectrumLevel = 0;

    private int regionOID = 0;
    //星座ID
    private int conOID = 0;
    //星座序号
    ...
    //逃逸速度
    private double cosmic1 = 0.0;
    //第二宇宙速度
    private double cosmic2 = 0.0;
    //绝对星等
    private double absMang = 0.0;
    ...
    public double getCosmic1()
    {
        return cosmic1;
    }

    public void setCosmic1(double cosmic1)
    {
        this.cosmic1 = cosmic1;
    }

    public double getCosmic2()
    {
        return cosmic2;
    }

    public void setCosmic2(double cosmic2)
    {
        this.cosmic2 = cosmic2;
    }

    public double getAbsMang()
    {
        return absMang;
    }

    public void setAbsMang(double absMang)
    {
        this.absMang = absMang;
    }
    ...
    public String getGeneSeed()
    {
        return geneSeed;
    }

    public void setGeneSeed(String geneSeed)
    {
    ...
    public int getRegionOID()
    {
        return regionOID;
    }

    public void setRegionOID(int regionOID)
    {
