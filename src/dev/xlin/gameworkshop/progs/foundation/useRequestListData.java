 ...
 * @author 刘祎鹏
 */
public class useRequestListData implements iDataPageOper, iDataColumnOper, iDataElementOper, iAdtXML, iAdtDocumentSave, iDatablockFace, iDatablockInitInstance, iDatablockClearValue, iDatablockCopy
{
    ...
    private int doCheckBeanLogic(BeanUseRequestData bean)
    {
        ...
        if (b00 == false)
        {
            System.err.println(" constChk.isConst(iConst.class, \"TARGET_REQ_METD_\", bean.getRequestType());");
            return 1;
        }
        boolean b01 = constChk.isConst(iConst.class, "DT_REQ_TARTYPE_", bean.getTargetType());
        if (b01 == false)
        {
            System.err.println(" constChk.isConst(iConst.class, \"DT_REQ_TARTYPE_\", bean.getTargetType());");
            return 1;
        }
    ...
    {
        return "SYS_DB_USE_REQUEST_LIST";
    }
    ...
    public Object datablockCopy()
    {
        ...
        iAdtXML iax = new useRequestListData();
