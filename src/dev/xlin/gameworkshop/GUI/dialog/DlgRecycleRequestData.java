 ...
 * @author 刘祎鹏
 */
public class DlgRecycleRequestData extends javax.swing.JDialog
{

    private BeanRecycleRequestListData bean = null;
    ...
    public DlgRecycleRequestData(java.awt.Frame parent, boolean modal, wakeup _up, BeanRecycleRequestListData _bean)
    {
        super(parent, modal);
        initComponents();
        up = _up;
    ...
    private void initGUI()
    {
        ...
        if (bean == null)
        {
            bean = new BeanRecycleRequestListData();
            bEdit = false;
        ...
        else
        {
            tarID = bean.getTargetOID();
            tarType = bean.getTargetType();
            txtValue.setText(bean.getQuantity() + "");
        ...
        swsys.doSelectCombo(cmbValueMethod, bean.getRequestMethod());
        System.err.println(".mtd = " + bean.getRequestMethod());
        makeCtrlsByTarType();
    }
    ...
    private void doOK()
    {
        ...
        bean.setRequestMethod(swsys.getComboBoxSelected(cmbValueMethod));
        bean.setQuantity(dv);
    ...
    public BeanRecycleRequestListData getRecycleRequestListData()
    {
        return bean;
    }
